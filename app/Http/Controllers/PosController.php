...
class PosController extends Controller
{
    ...
    public function updateCartItem(Request $request, $rowId)
    {
        ...
        /**
     * Handle update product price in cart.
     */
    public function updateCartItemPrice (Request $request, $rowId)
    {
        $rules = [
            'price' => 'required|numeric',
        ];
        ...
        return Redirect::back()->with('success', 'Product Price has been updated from cart!');
    }
