                                        ...
                                        <form action="{{ route('pos.updateCartItem', $item->rowId) }}" method="POST">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="input-group-append">
                                                    <button type="submit" class="btn btn-success border-none d-none d-md-block" data-toggle="tooltip" data-placement="top" title="" data-original-title="Sumbit"><i class="fas fa-check"></i></button>
                                                </div>
                                            </div>
                                        </form>
                                    </td>
                                    <td style="min-width:140px; max-width:140px;">
                                        <form action="{{ route('pos.updateCartItemPrice', $item->rowId) }}" method="POST">
                                            @csrf
                                            <div class="input-group">
                    ...
                    <!-- Form Group (customer) -->
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input id="today" class="form-control form-control-solid fw-bold text-red" name="date" type="date">
                            ...
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control form-control-solid fw-bold text-red" name="discount" type="number">
                                </div>
